...
class AIDetectionNode(Node): # Renombrado el nodo a AIDetectionNode
    def __init__(self):
        ...
        # Eliminamos el publisher MarkerArray y el publisher image_pub duplicado.
    ...
    def image_callback(self, msg):
        ...
        results = self.model(cv_image, imgsz=512, device=self.device, verbose=False, stream=True, conf=0.3) 
